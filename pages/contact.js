...
const Contact = () => {
    ...
    const sendEmail = async (event) => {
        ...
        if (!form.current) {
            console.error("Form reference missing.");
            return;
        }

        const { name, email, subject, message } = form.current;
        ...
        try {
            ...
            toast(result.message, {
                ...
                icon: () => <Image src="/assets/icons/circle-check-solid-full.svg" alt="checklist icon" className="toast-icon" width={25} height={25} />
            });
            ...
            toast(error.message || "Failed to send a message", {
                ...
                className: 'message-toast',
                progressClassName: 'message-progress-bar',
                icon: () => <Image src="/assets/icons/circle-exclamation-solid-full.svg" alt="exclamation icon" className="toast-icon" width={25} height={25} />
            });
        }
    };
